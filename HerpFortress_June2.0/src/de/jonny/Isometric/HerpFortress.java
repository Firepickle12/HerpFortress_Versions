...
public class HerpFortress extends Canvas implements Runnable {
	...
	private void render(Bitmap screen) {
		...
		// Debug
		showDebugInfo(screen);
		
		// Render Level
		level.render(screen);
	}
	
	public void showDebugInfo(Bitmap screen) {
		int x0 = 80;
		int y0 = 50;
		int x1 = 95;
		int y1 = 100;
		
		screen.box(x0, y0, x1, y1, 0xff00ff);
		System.out.println("In sel. area: " + level.getEntities(x0, y0, 0, x1, y1, 1));
	}
